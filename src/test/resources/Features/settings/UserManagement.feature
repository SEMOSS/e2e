...
#
  ...
  Scenario: Add New Native User with Unique Incremental Details - Validate profile info
    ...
    And User adds 1 members with name "TestUser", userId "TestId", password "Test@123", and email domain "testautomation.com" and can see toast message as 'Successfully added user' for all added members
