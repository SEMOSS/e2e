...
#	@DeleteTestCatalog
    ...
    #And User select the 'TestDatabase' in the 'Select Engine' field of Add Engine form
...
#
    ...
    #And User clicks on the team name 'Test Team' in the list
    #When User clicks on 'Add Engine' button in Team Permission page 
    #And User select the 'WeatherFunctionTest' in the 'Select Engine' field of Add Engine form
    #And User select the engine access as '<Role>'
    #And User clicks on save button
    #Then User sees the message 'Successfully added engine permission' is displayed 
...
#
    ...
    #And User clicks on the team name 'Test Team' in the list
    #When User clicks on 'Add Engine' button in Team Permission page 
    #And User select the 'Amazon S3 Storage' in the 'Select Engine' field of Add Engine form
    #And User select the engine access as '<Role>'
    #And User clicks on save button
    #Then User sees the message 'Successfully added engine permission' is displayed 
...
#
 ...
 @DeleteTestCatalog
    ...
    And User clicks on the team name 'Test Team' in the list
    When User clicks on 'Add Engine' button in Team Permission page 
    And User select the 'FAISS Vector DB01' in the 'Select Engine' field of Add Engine form
    And User select the engine access as '<Role>'
    And User clicks on save button
    Then User sees the message 'Successfully added engine permission' is displayed 
