 ################# UI does not have option to update app diabetes template. Hence commenting the feature file ####################
...
#     And User selects "Update Diabetes Record" from Template List
...
#     And User click on 'Update' Record button
