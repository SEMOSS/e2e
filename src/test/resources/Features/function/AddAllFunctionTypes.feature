...
Feature: Validate all function types
  ...
  Scenario Outline: Validate '<FUNCTION>' function
    ...
    Examples: 
      ...
      | Azure Document Intelligence | General | Function Type, Catalog Name | Credentials | API Key                | Settings | URL                                                                                                                                                                  | Function Type, Catalog Name, URL, API Key                                                                                                                                           | Catalog Name=Azure-Document-Intelligence, URL=https://www.google.com, API Key=Test123                                                                                                                                                                                                                  |
