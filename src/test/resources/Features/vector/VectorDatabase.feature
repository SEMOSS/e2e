Feature: Vector Database
  ...
  Scenario: Create Vector Databases
    ...
    And User enters 'Catalog Name' as 'FAISSCatalogeVector'
    ...
    Then User should see the 'FAISSCatalogeVector' vector on the Vector Catalog page
  ...
  Scenario: Add Tag
    ...
    And User clicks on vector 'My Vectors' tab
    And User searches 'FAISSCatalogeVector' vector in the vector searchbox
    When User clicks on the vector 'FAISSCatalogeVector'
  ...
  Scenario: Add Domain
    ...
    And User clicks on vector 'My Vectors' tab
    And User searches 'FAISSCatalogeVector' vector in the vector searchbox
    And User clicks on the vector 'FAISSCatalogeVector'
    And User clicks on vector Edit button
  ...
  Scenario: Bookmark Vector
    ...
    And User clicks on vector 'My Vectors' tab
    And User searches 'FAISSCatalogeVector' vector in the vector searchbox
    And User clicks on Bookmark icon of 'FAISSCatalogeVector' then the vector is bookmarked
    And User clicks on Unbookmark icon of 'FAISSCatalogeVector' then the vector is unbookmarked
    And User clicks on the vector 'FAISSCatalogeVector'
