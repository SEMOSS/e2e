...
public class JobPageLoadingTests extends AbstractE2ETest {
	...
	void testLoadPage() {
		...
		isMessageVisible = JobPageUtils.verifyNoJobHistoryMessageOnJobPage(SetupHooks.getPage(), message);
	...
	void testViewDisabledButtons(String btn) {
		boolean isButtonDisabled = JobPageUtils.verifyButtonsDisabledOnJobPage(SetupHooks.getPage(), btn);
