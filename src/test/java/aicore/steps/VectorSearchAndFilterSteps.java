...
public class VectorSearchAndFilterSteps {
	...
	public void user_should_see_the_on_the_vector_catalog_page(String vectorName) {
		...
		Assertions.assertTrue(isVectorDisplayed, "Vector catalog not displayed on page");
	}
	...
	@When("User clicks on Unbookmark icon of {string} then the vector is unbookmarked")
	public void user_clicks_on_unbookmark_icon(String bookmark) {
		openVectorPage.UnBookmarkVector(bookmark);
	}
	...
	public void user_clicks_on_create_vector_button() throws InterruptedException {
