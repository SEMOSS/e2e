...
public class ViewStorageSteps {
	...
	public void user_can_see_the_storage_title_as(String storageTitle) {
		String actualTitle = viewStorage.getStorageTitle(storageTitle + AddStorageSteps.timestamp);
		String expectedTitle = storageTitle + AddStorageSteps.timestamp;
	...
	public void user_should_see_domain_in_overview_tab(String expectedDomain) {
		Assertions.assertTrue(viewStorage.isFilterValueVisibleInOverview(expectedDomain),
				"'" + expectedDomain + "' not visible in Overview tab");
	}
	...
	public void user_should_see_confidential_in_overview_tab(String expectedDataClassificationValue) {
		Assertions.assertTrue(viewStorage.isFilterValueVisibleInOverview(expectedDataClassificationValue),
				"'" + expectedDataClassificationValue + "' not visible in Overview tab");
	}
	...
	public void user_should_see_confidential_allowed_in_overview_tab(String expectedDataRestrictionValue) {
		Assertions.assertTrue(viewStorage.isFilterValueVisibleInOverview(expectedDataRestrictionValue),
				"'" + expectedDataRestrictionValue + "' not visible in Overview tab");
	}
