...
//		page.locator("div").waitFor(new WaitForOptions().setTimeout(500))
...
//					.getByRole(AriaRole.BUTTON).click();
	...
	void testLoginIncorrect() {
		...
		Response response = page
				.waitForResponse(getApi("/api/auth/login"), () -> page
	...
	void loginAndLogout() {
	    ...
	    page.locator("div").filter(new Locator.FilterOptions().setHasText(Pattern.compile("^SEMOSS$"))).getByRole(AriaRole.BUTTON).click();
