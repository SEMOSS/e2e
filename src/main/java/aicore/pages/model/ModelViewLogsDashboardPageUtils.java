...
public class ModelViewLogsDashboardPageUtils {
	private static final String DASHBOARD_HEADING_XPATH = "//h6[contains(normalize-space(), 'Model Insight Dashboard')]";
	...
	private static final String DASHBOARD_LINK_XPATH = "//*[contains(@class,'lucide lucide-square-chart-gantt size')]";
	...
	public static void navigateToModelInsightDashboard(Page page) {
		Locator dashboardLink = page.locator(DASHBOARD_LINK_XPATH).nth(1);
