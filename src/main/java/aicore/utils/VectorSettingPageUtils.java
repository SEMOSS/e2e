...
public class VectorSettingPageUtils {
    ...
    private static final String VECTOR_CARDS_XPATH = "//div[contains(@class,'MuiPaper-root-MuiCard-root')]";
   ...
   public static void verifyVectorSettingTitle(Page page, String title) {
    ...
    if (vectorCardCount < 1) {
        throw new AssertionError("Expected vector count should be more than or equal to 1 vector card, but found 0.");
    }
    }   
