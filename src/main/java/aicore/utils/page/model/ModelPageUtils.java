...
public class ModelPageUtils {
	...
	public static void verifyChatSectionDisplayed(Page page, String title) {
		...
		if(!chatTabTitle.isVisible()) throw new RuntimeException("Chat tab title is not displayed");
	}
	public static void verifyTemperatureValue(Page page, String temperatureValue) {
		...
		if(!actualTemperatureValue.equalsIgnoreCase(temperatureValue)) {
			throw new PlaywrightException("Temperature value is not matching. Expected: "+temperatureValue+" but found: "+actualTemperatureValue);
		}
	}
	...
	public static void verifyMaxTokensValue(Page page, String maxTokensValue) {
		...
		if(!actualMaxTokensValue.equalsIgnoreCase(maxTokensValue)) {
			throw new PlaywrightException("Max tokens value is not matching. Expected: "+maxTokensValue+" but found: "+actualMaxTokensValue);
		}
	}
	public static void verifyInputTextboxPlaceholder(Page page, String defaultValue) {
		...
		if(!placeholderInputValue.equalsIgnoreCase(defaultValue)) {
			throw new PlaywrightException("Input textbox placeholder is not matching. Expected: "+defaultValue+" but found: "+placeholderInputValue);
		}
	}
	...
	public static void verifyModelIDAndNameDisplayed(Page page) {
		...
		if(!modelIDText.equalsIgnoreCase(chatModelIDText)) {
			throw new PlaywrightException("Model ID in Chat section does not match with Model Information section"+modelIDText+" "+chatModelIDText);
		}
		if(!modelNameText.equalsIgnoreCase(chatModelNameText)) {
			throw new PlaywrightException("Model Name in Chat section does not match with Model Information section"+modelNameText+" "+chatModelNameText);
		}
