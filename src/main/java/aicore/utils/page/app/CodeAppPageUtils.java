...
public class CodeAppPageUtils {
    ...
    public static void userCanSeeFolderUnderParentFolder(Page page, String folderName, String parentFolderName) {
    	Locator folderLocator=page.locator(SUBFOLDERORFILE_XPATH.replace("{parentFolder}", parentFolderName).replace("{subFolder}", folderName));
    ...
    public static void userCanSeeFileUnderParentFolder(Page page, String fileName, String parentFolderName) {
    	Locator fileLocator = page.locator(SUBFOLDERORFILE_XPATH.replace("{parentFolder}", parentFolderName).replace("{subFolder}", fileName));
