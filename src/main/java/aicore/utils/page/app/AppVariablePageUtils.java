...
public class AppVariablePageUtils {
    ...
    public static void clickOnVariableOption(Page page) {
        boolean VariableIconIsVisible = page.locator(VariableOption).isVisible();
    ...
    public static void selectVariableType(Page page, String variableType) {
        ...
        if (variableTypeButton.isVisible()) {
            ...
            Locator variableTypeDropdownListOption = page.locator(VariableTypeDropdownList.replace("{variableType}", variableType));
    ...
    public static void setVariableValue(Page page, String variableValue) {
        ...
        if (VariableValue.isVisible()) {
            VariableValue.click();
            Locator variableValueDropdownListOption = page.locator(VariableValueInputDropdownList.replace("{value}", variableValue));
