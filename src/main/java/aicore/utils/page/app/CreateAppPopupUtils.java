...
public class CreateAppPopupUtils {
	private static final String CODE_APP_GET_STARTED_BUTTON_XPATH = "//div[.//div[normalize-space()='Develop in code']]/following-sibling::div//button[normalize-space()='Get Started']";
	...
	public static void clickOnGetStartedButton(Page page, String appType) {
		if (appType.toLowerCase().contains("agent")) {
			...
			page.locator(CODE_APP_GET_STARTED_BUTTON_XPATH).first().click();
		}
	}
