...
public class PlaygroundPageUtils {
	...
	public static void verifyWorkspaceCreatedWithDescription(Page page, String workspaceName, String description) {
		...
		if (!workspaceDescription.isVisible()) {
			throw new AssertionError(
					"Expected description: " + description + ", but found: " + workspaceDescription.textContent());
		}
	}
	...
	public static void verifyWorkspaceDisplayedInSearchResults(Page page, String workspaceName) {
		...
		if (!workspaceTitle.equals(workspaceName)) {
			throw new AssertionError(
					"Search function failed. Expected workspace: " + workspaceName + ", but found: " + workspaceTitle);
		}
	}
	...
	public static void verifyWorkspaceSelectionInMenu(Page page, String workspaceName, String menuName) {
		...
		if (!workspaceProfile.isVisible()) {
			throw new AssertionError("did not select the correct workspace. Expected workspace: " + workspaceName
					+ ", but workspace profile is not visible.");
		}
	}
	...
	public static void clickVerifyKnowledgeVisibleInAvailableTools(Page page, String knowledgeName) {
		Locator KnowledgeToolLocator = page.locator(KNOWLEDGE_CHECKBOX_XPATH.replace("{KNOWLEDGE}", knowledgeName))
				.first();
